...
describe("Update Challanges", async () => {
  it("Update Challanges Successfully", async () => {
    const response = await chai
      .request(app)
      .put(
        constants.challangeApi.updatechallangeurl +
          constants.challangeApi.updatechallangeId
      )
  ...
  it("Update Challanges with invalid Id", async () => {
    const response = await chai
      ...
      .put(
        constants.challangeApi.updatechallangeurl +
          constants.challangeApi.updatechallangeInvalidId
      )
      .set("authtoken", constants.token)
      .send({
        title: "Challange Given By Punit",
  ...
  it("Update Challanges with Id not exist", async () => {
    const response = await chai
      ...
      .put(
        constants.challangeApi.updatechallangeurl +
          constants.challangeApi.updatechallangeNotFound
      )
      .set("authtoken", constants.token)
      .send({
        title: "Challange Given By Punit",
  ...
  it("Update Challanges of others account", async () => {
    const response = await chai
      ...
      .put(
        constants.challangeApi.updatechallangeurl +
          constants.challangeApi.updatechallangeNotOfAccount
      )
      .set("authtoken", constants.token)
      .send({
        title: "Challange Given By Punit",
